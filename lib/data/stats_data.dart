import 'package:covid_stats/data/covid_stats.dart';
...
class StatsData {
  ...
  // var apilink = 'https://covid19.mathdro.id/api';
  // var stats;
...
// ...............................................................................
  ...
  void printData() async {
    ...
    var data = await http.get(countryUrl);
    
    var countries = convert.jsonDecode(data.body);

    // for(var i = 0; i< countries['countries'].length; i++)
    //   print(countries['countries'][i]['name']);

    countries['countries'].forEach((val) => print(val['name'])); 
  }
